...
export default function Home(){
 ...
 return <main>
  ...
  <section id="top" className="hero"><div className="eyebrow">MARTIN J. BALL, ED. · 2005</div><h1>讀語言，也讀進<br/><em>一個人的生活裡。</em></h1><p>21 章閱讀心得，從社會網絡、多語生命史與公平評估，走向高齡阿美語與神經認知研究的設計草圖。</p><div className="hero-actions"><a className="download-pack" href="/clinical-sociolinguistics-apa7-research-pack.docx" download><span>↓</span><b>下載 APA 7 Word 研究包</b><small>圖表數據 · 脈絡圖 · 研究缺口 · 阿美族研究連結</small></a></div><div className="hero-stats">{[['21','章節'],['5','主題群'],['16','已整理'],[String(read.length),'我的已讀']].map(x=><div key={x[1]}><strong>{x[0]}</strong><span>{x[1]}</span></div>)}</div></section>
